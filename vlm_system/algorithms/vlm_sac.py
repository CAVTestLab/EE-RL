...
SelfVLMRewardedSAC = TypeVar("SelfVLMRewardedSAC", bound="VLMRewardedSAC")


class VLMRewardedSAC(SAC):
    ...
    def collect_rollouts(
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            # Align buffer actions with environment-executed actions in vectorized runs.
